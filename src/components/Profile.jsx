...
export default function Profile() {
  ...
  return (
    <>
      <NavBar />
      {profile ? (
        <div className="font-serif max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-28 lg:my-0">
          <div
            id="profile"
          ...
          >
            <div className="p-4 md:p-12 text-center lg:text-left">
              ...
              <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                ...
                {profile.owner.user_type}@ Vell Magazine
              </p>
              <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                <MapPinIcon className="w-6 h-6 mr-3" />
                Location - London, UK
              </p>
              <h2 className="text-gray-800 text-2xl lg:text-3xl font-semibold pt-10">
                Bio
              </h2>
              <p className="pt-8 text-sm">{profile.bio}</p>
